...
/* package plp-0.1.0.0 */
#ifndef VERSION_plp
#define VERSION_plp "0.1.0.0"
#endif /* VERSION_plp */
#ifndef MIN_VERSION_plp
#define MIN_VERSION_plp(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_plp */
...
#define CURRENT_COMPONENT_ID "plp-0.1.0.0-inplace-plp"
