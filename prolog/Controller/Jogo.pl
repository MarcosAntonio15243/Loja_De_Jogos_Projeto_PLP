:- module(jogo,
    ...
    jogoExiste/2,
    exibir_jogos/1,
    print_jogo_id_nome_rest/1,
    print_jogo_id_nome/1,
...
exibir_jogos([Jogo|OutrosJogos]) :-
    writeln('================================================================================'),
    writeln('                            LISTA DE JOGOS                                    '),
    writeln('================================================================================'),
    print_jogo_id_nome(Jogo),
    writeln('--------------------------------------------------------------------------------'),
    print_jogo_id_nome_rest(OutrosJogos), !.

print_jogo_id_nome_rest([]).

print_jogo_id_nome_rest([Jogo|OutrosJogos]) :-
    print_jogo_id_nome(Jogo),
    writeln('--------------------------------------------------------------------------------'),
    print_jogo_id_nome_rest(OutrosJogos).

print_jogo_id_nome(row(ID, Nome, _, _, _, _, _)) :-
